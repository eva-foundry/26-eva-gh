# GitHub Copilot Instructions -- EVA GitHub Ecosystem

**Template Version**: 3.0.0
**Last Updated**: February 23, 2026
**Project**: EVA GitHub Ecosystem -- GitHub ecosystem hub hosting cloned EVA sub-repos (rag, registry, safety, UI variants, sovereign) with cloud housekeeping scripts.
**Path**: `C:\AICOE\eva-foundry\26-eva-gh\`
...
4. **Query the data model** for this project's record:
   `powershell
   Invoke-RestMethod "http://localhost:8010/model/projects/26-eva-gh" | Select-Object id, maturity, notes
   `
...
This file is the copilot-instructions for **26-eva-gh** (EVA GitHub Ecosystem).
...
Once this file has been loaded, the active project is locked to **26-eva-gh** for the entire session.
...
**Name**: EVA GitHub Ecosystem
**Folder**: `C:\AICOE\eva-foundry\26-eva-gh`
**ADO Epic**: [TODO]
**37-data-model record**: `GET /model/projects/26-eva-gh`
**Maturity**: poc
**Phase**: Phase 1 -- Sub-repo Clones
...
Invoke-RestMethod "http://localhost:8010/model/endpoints/" |
  Where-Object { $_.implemented_in -like '*26-eva-gh*' } |
