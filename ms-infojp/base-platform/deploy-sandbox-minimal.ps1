...
# Total cost: ~$120/month for 1-2 users with 3GB data
...
Write-Host "`nEstimated cost: ~$120/month" -ForegroundColor Green
Write-Host "  - App Services (3x B1): $39/month" -ForegroundColor Gray
Write-Host "  - Cognitive Search Basic: $75/month" -ForegroundColor Gray
Write-Host "  - Cosmos DB Serverless: ~$5/month" -ForegroundColor Gray
Write-Host "  - Storage: ~$5/month for 3GB" -ForegroundColor Gray
...
# App Service Basic B1: ~`$13/month each (1.75 GB RAM, 1 vCore)
...
# Cognitive Search Basic: ~`$75/month (2GB storage, 15 indexes, 50 indexers)
